...
class SimpleViewer(ShowBase):
    def __init__(self, fStartDirect=True, windowType=None):
        ...
        color = [141/255,141/255,170/255,1]
    ...
    def load_character(self):
        info = np.load('character_model_new.npy', allow_pickle=True).item()
    ...
    def move_marker_to_pos(self, marker, pos):
        marker.setPos(self.render, *pos)

    def create_marker_base(self, pos, color):
    ...
    def create_marker(self, pos, color):
        marker = self.create_marker_base(pos, color)
